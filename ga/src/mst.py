    ...
    def add_edges(self, final_points, obstacles):
        ...
        for i in range(len(final_points)):
            for j in range(i + 1, len(final_points)):
                if Collision.is_line_intersecting_solid_polygons([final_points[i], final_points[j]], obstacles):
                    self.add_edge(i, j, float("inf"))
                elif Collision.is_line_intersecting_polygons([final_points[i], final_points[j]], obstacles):
